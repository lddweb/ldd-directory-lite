...
function lddlite_swap_metaboxes()
{
    ...
    add_meta_box( 'submitdiv', __( 'Approval' ), 'lddlite_post_submit_meta_box', NULL, 'side', 'high', null );
}


function lddlite_post_submit_meta_box($post, $args = array() ) {
    global $action;
