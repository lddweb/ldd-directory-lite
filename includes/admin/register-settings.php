        ...
        'general' => apply_filters( 'lddlite_settings_general',
            array(
                ...
                'category_sort_separator' => array(
                    ...
                    'name' => '<h3 class="title">' . __( 'Category Sort', 'ldd-directory-lite') . '</h3>',
                    'type' => 'header'
                ),
                ...
                'featured_sort_separator' => array(
                    ...
                    'name' => '<h3 class="title">' . __( 'Featured Listings Sort', 'ldd-directory-lite') . '</h3>',
                    'type' => 'header'
                ),
                ...
                'listings_sort_separator' => array(
                    ...
                    'name' => '<h3 class="title">' . __( 'Listings Sort', 'ldd-directory-lite') . '</h3>',
                    'type' => 'header'
                ),
