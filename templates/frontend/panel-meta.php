			...
			<div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="f_url_instagram" class="form-control" name="n_url_instagram" value="<?php echo ldl_get_value( 'url_instagram' ); ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="f_url_youtube" class="form-control" name="n_url_youtube" value="<?php echo ldl_get_value( 'url_youtube' ); ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="f_url_custom" class="form-control" name="n_url_custom" value="<?php echo ldl_get_value( 'url_custom' ); ?>">
