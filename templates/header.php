    ...
    <div class="container-fluid">
        ...
        <div id="navbar-directory" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                	<li><a href="<?php echo ldl_get_directory_link(); ?>"><?php _e('Home', 'ldd-directory-lite'); ?></a></li>
                <?php if (ldl()->get_option('directory_submit_page')): ?>
                	<li><a href="<?php echo ldl_get_submit_link(); ?>"><?php _e('Submit Listing', 'ldd-directory-lite'); ?></a></li>
				<?php endif; ?>
                <?php if (ldl()->get_option('directory_manage_page')): ?>
                	<li><a href="<?php echo ldl_get_manage_link(); ?>"><?php _e('Manage Listings', 'ldd-directory-lite'); ?></a></li>
				<?php endif; ?>
                	<li class="dropdown">
