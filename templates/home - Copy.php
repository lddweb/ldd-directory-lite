...
if(ldl()->get_option( 'view_controls' )=="yes"){?>
    <div class="row view_controls">
        <div class="col-md-4"><a class="<?php echo $category;?>" href="?ldd_view=grid">Grid</a> | <a class="<?php echo $listing;?>" href="?ldd_view=compact">Compact</a></div>
     </div>
<?php } ?>
    ...
    <div class="container-fluid">
        ...
        <?php if (ldl()->get_option('home_page_listing') =='category'):?>
        <h2> Categories</h2>
...
// Directory Listing
   if (ldl()->get_option('home_page_listing') =='listing'):
     ...
     if (ldl()->get_option('directory_view_type') =='map'){?>
            <div class="col-md-12">
                <div id="map_wrapper">
            ...
            while ($dir_list->have_posts()): $dir_list->the_post(); ?>
