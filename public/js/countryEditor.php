...
function formElemCountry() {
	...
	case "United States":
		jQuery("#selectedCountryForm").html(
			...
			"<input type='text' id='lddbd_address_city' name='address_city' value='<?php echo $business->address_city; ?>' /><br />" +
			"</div>" +
			"<div class='lddbd_input_holder'>" +
			"<label for='name'><?php _e('State:', 'lddbd-text'); ?></label>" +
	...
	// Start the loop that generates the list of US states
		...
		<?php $textLine = fgets( $statesUSA_List ); $textLine = trim( $textLine ); ?>
			"<option <?php if( $business->address_state == $textLine ) echo 'selected=\"selected\"'; ?> ><?php esc_attr_e($textLine, 'lddbd-text'); ?></option>" +
		<?php } ?>
	...
	case "Switzerland":
		jQuery("#selectedCountryForm").html(
			"<div class='lddbd_input_holder'>" +
			"<label for='name'><?php _e('Postcode:', 'lddbd-text'); ?></label>" +
			"<input type='text' id='lddbd_address_zip' name='address_zip' value='<?php echo $business->address_zip; ?>' /><br />" +
			"</div>" +
			"<div class='lddbd_input_holder'>" +
			"<label for='name'><?php _e('City / Town:', 'lddbd-text'); ?></label>" +
