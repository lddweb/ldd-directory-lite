...
function formElemCountry() {
	...
	// End the loop that generates the list of US states
			...
			"</div>" +
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>ZIP Code:</label> <input type='text' id='lddbd_address_zip' name='address_zip' value='<?php echo $business->address_zip; ?>' />" +
			"</div>"
		);
	...
	// End the loop that generates the list of Australian states/territories
			...
			"</div>" +
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>Postcode:</label> <input type='text' id='lddbd_address_zip' name='address_zip' value='<?php echo $business->address_zip; ?>' />" +
			"</div>"
		);
		...
		jQuery("#selectedCountryForm").html(
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>Postcode:</label> <input type='text' id='lddbd_address_zip' name='address_zip' value='<?php echo $business->address_zip; ?>' /><br />" +
			"</div>" +
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>City / Town:</label> <input type='text' id='lddbd_address_city' name='address_city' value='<?php echo $business->address_city; ?>' />" +
			"</div>"
		);
	...
	// End the loop that generates the list of Canadian provinces/territories
		...
		jQuery("#selectedCountryForm").html(
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>Postal Code and District:</label> <input type='text' id='lddbd_address_zip' name='address_zip' value='<?php echo $business->address_zip; ?>' /><br />" +
			"</div>" +
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>City / Town / Village:</label> <input type='text' id='lddbd_address_city' name='address_city' value='<?php echo $business->address_city; ?>' />" +
			"</div>"
		);
	} else if ( selectedCountry == "Finland" ) {
		jQuery("#selectedCountryForm").html(
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>Postal Code and District:</label> <input type='text' id='lddbd_address_zip' name='address_zip' value='<?php echo $business->address_zip; ?>' />" +
			"</div>"
		);
		...
		jQuery("#selectedCountryForm").html(
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>Postal Code:</label> <input type='text' id='lddbd_address_zip' name='address_zip' value='<?php echo $business->address_zip; ?>' /><br />" +
			"</div>" +
			"<div class='lddbd_input_holder'>" +
			"<label for='name'>City / Town:</label> <input type='text' id='lddbd_address_city' name='address_city' value='<?php echo $business->address_city; ?>' /><br />" +
			"</div>" +
